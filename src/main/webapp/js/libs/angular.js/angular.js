/**
 * @license AngularJS v1.4.0-local+sha.c211e7a
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message += '\nhttp://errors.angularjs.org/1.4.0-local+sha.c211e7a/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.4.0-local+sha.c211e7a',    // all of these placeholder strings will be replaced by grunt's
